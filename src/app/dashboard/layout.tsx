...
import { LayoutDashboard, Users, CreditCard, Settings, PlusCircle, LogOut, UserCircle } from "lucide-react";
      ...
      <aside className="w-64 glass-card border-r border-slate-200 dark:border-slate-800 hidden md:flex flex-col">
        <div className="p-6">
          ...
          <nav className="space-y-2">
            ...
            <SidebarItem icon={<UserCircle size={20} />} label="My Profile" href="/dashboard/settings" />
